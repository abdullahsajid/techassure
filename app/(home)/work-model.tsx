    ...
    <div id="services" className="py-12 overflow-x-clip">
      <div className="container">
        <motion.p
          ...
          viewport={{ once: true }}
          className="text-primary text-center origin-left font-SatoshiBold font-[900] text-3xl leading-[21px] tracking-widest uppercase mb-4"
        >
          Work Model
        </motion.p>
      </div>
      ...
      >
        <h4 className="container text-center text-[#111] font-SatoshiBold text-lg md:text-xl lg:text-2xl">
        ...
        >
            <h4 className="container text-[#111] text-center font-SatoshiBold text-lg md:text-xl lg:text-2xl">
